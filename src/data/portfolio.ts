...
export const experience = [
  {
    ...
    highlights: [
      ...
      "Leverage LLMs and Model Context Protocol in building AI-assisted applications",
      "Use AI agents (GitHub Copilot, Cline) to accelerate development by 80%",
      "Mentor 6 engineers in team",
    ],
  ...
  },
  {
    ...
    highlights: [
      "Part of OSR team working on SHA initiatives and system modernization",
      "Created solution for migrating background batch jobs to Hangfire",
      "Designed performant queueing system improving reliability",
      "Integrated Windows services using WCF",
      "Implemented WebSocket for real-time progress notifications",
      "Refactored applications for significant performance gains",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "Implemented quote pricing with automated underwriting approval (<5 seconds)",
      "Optimized document generation reducing time by 5+ seconds",
      "Constructed mapping layer and stored procedures for seamless integration",
      "Integrated Stripe Payment Gateway for post-payment workflows",
    ],
